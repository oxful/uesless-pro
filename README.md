...
```bash
python get_all_stock_history.py
```

- Train a model only on 600004.csv; no embedding
```bash
python main.py --stock_symbol=600004 --train --input_size=1 --lstm_size=128 --max_epoch=50
```


- Prediction a model of stock 600004;
```bash
python main.py --stock_symbol=600004 --prediction --input_size=1 --lstm_size=128 --max_epoch=50
```
